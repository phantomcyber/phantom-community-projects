...
class ZoomConnector(BaseConnector):
    ...
    def _handle_test_connectivity(self, param):
        ...
        # make rest call
        ret_val, response = self._make_rest_call('/users', action_result, params=None, headers=None)
    ...
    def _handle_get_files(self, param):
        ...
        ret_val, response = self._make_rest_call('/past_meetings/{}/files'.format(meeting_id), action_result, params=None, headers=None)
        ...
        action_result.add_data({'in_meeting_files': response.get('in_meeting_files', {})})
        return action_result.set_status(phantom.APP_SUCCESS, 'Meeting files successfully retrieved'.format(meeting_id))
    ...
    def _handle_get_user_settings(self, param):
        ...
        return action_result.set_status(phantom.APP_SUCCESS, 'User settings ({}) successfully retrieved'.format(user_id))
    ...
    def _handle_update_user_settings(self, param):
        ...
        pmi_password = password = self._get_password(param.get('pmi_password'), param.get('gen_pmi_password'))
        ...
        ret_val, response = self._make_rest_call('/users/{}/settings'.format(user_id), action_result, json=data, headers=None, method="patch")
    ...
    def _handle_delete_meeting(self, param):
        ...
        ret_val, response = self._make_rest_call('/meetings/{}'.format(meeting_id), action_result, headers=None, method="delete")
    ...
    def _handle_update_meeting(self, param):
        ...
        ret_val, response = self._make_rest_call('/meetings/{}'.format(meeting_id), action_result, json=data, headers=None, method="patch")
    ...
    def _handle_get_meeting_invite(self, param):
        ...
        action_result.add_data(response)
        return action_result.set_status(phantom.APP_SUCCESS, 'Meeting invitation ({}) successfully retrieved'.format(meeting_id))
    ...
    def _handle_get_user(self, param):
        ...
        action_result.add_data(response)
        return action_result.set_status(phantom.APP_SUCCESS, 'User information ({}) successfully retrieved'.format(user_id))
    ...
    def _handle_get_meeting(self, param):
        ...
        action_result.add_data(response)
        return action_result.set_status(phantom.APP_SUCCESS, 'Meeting information ({}) successfully retrieved'.format(meeting_id))
    ...
    def handle_action(self, param):
        ...
        elif action_id == 'get_files':
            ret_val = self._handle_get_files(param)
